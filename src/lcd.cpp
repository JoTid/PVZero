...
LCD::LCD()
{
   Serial.printf("Constructor LCD...\n");
}

LCD::~LCD()
{
   Serial.printf("Destroy LCD...\n");
}
...
void LCD::process(void)
{
   ...
   if (millis() > (slOldTimeS + LCD_REFRESH_TIME))
   {
      u8g2.clearBuffer();
      u8g2_prepare();
      u8g2.setFontDirection(0);
      ...
      // u8g2.drawTriangle(64, 0, 59, 10, 69, 10);
   ...
   u8g2.drawStr(128-u8g2.getStrWidth(String("12:12").c_str()), 0, String("12:12").c_str());  

   u8g2.setCursor(4, 16);
   u8g2.print("Consumption Power"); 

   u8g2.setCursor(4, 16+12);
   u8g2.print("Feed Power");
   ...
   u8g2.drawStr(128-u8g2.getStrWidth(String("55%").c_str()), 55, String("55%").c_str()); 
...
//                                                                                                                    //
//--------------------------------------------------------------------------------------------------------------------// 
void LCD::warning(void)
{
   static int32_t slDelayTimeT = 400/LCD_REFRESH_TIME;
   ...
   if (slDelayTimeT > 0)
   {
      ...
      slDelayTimeT--;
   } else if (slDelayTimeT > ((400/LCD_REFRESH_TIME)*(-1)))
   {
      slDelayTimeT--;
   } else
   {
      slDelayTimeT = (400/LCD_REFRESH_TIME);
   }
}
